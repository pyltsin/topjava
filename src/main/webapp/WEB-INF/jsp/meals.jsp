...
<section>
    ...
    <form method="post" action="meals/filter" id="filterForm">
        ...
        <button type="button" id="filterFormReset"><spring:message code="meal.reset"/></button>
    </form>
    <hr>
    ...
    <table class="table table-striped display" id="datatable">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr class="${meal.exceed ? 'exceeded' : 'normal'}" id="${meal.id}">
                ...
                <td><a class="delete" ><span class="glyphicon glyphicon-remove" aria-hidden="true"/></a></td>
            </tr>
        </c:forEach>
    </table>
</section>
